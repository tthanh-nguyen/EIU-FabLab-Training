...
//static void rgb_toggle1(RGB *rgb, Color color)
//{
//	if(rgb->state == HIGH)
//	{
//		rgb_setcolor(rgb,OFF);
...
//static void rgb_toggle2(RGB *rgb, Color color)
//{
//	if(rgb->state1 == HIGH)
//	{
//		rgb_setcolor(rgb,color);
...
//void rgb_blink1(RGB *rgb, Color color1, Color color2, uint16_t blink_time)
//{
...
//					rgb->last_time_on = HAL_GetTick();
//			}
//	if (HAL_GetTick() - rgb->last_time_on1 >= blink_time)
//			{
